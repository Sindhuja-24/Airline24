...
<nav class="main-menu top-menu">
  ...
  <div class="booking-page pt-16 min-h-screen bg-gray-50">
    <div class="max-w-4xl mx-auto px-4 py-8">
      ...
      <form id="booking-form" action="PaymentPage.jsp" method="POST">
        ...
        <c:forEach var="i" begin="0" end="${passengers - 1}">
          <div class="passenger-info bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label for="firstName_${i}" class="block text-sm font-medium text-gray-700 mb-1">First Name <span class="text-red-500">*</span></label>
                <input type="text" id="firstName_${i}" name="firstName_${i}" required class="input-field" />
              </div>
              <div>
                <label for="lastName_${i}" class="block text-sm font-medium text-gray-700 mb-1">Last Name <span class="text-red-500">*</span></label>
                <input type="text" id="lastName_${i}" name="lastName_${i}" required class="input-field" />
              </div>
              <div>
                <label for="email_${i}" class="block text-sm font-medium text-gray-700 mb-1">Email <span class="text-red-500">*</span></label>
                <input type="email" id="email_${i}" name="email_${i}" required class="input-field" />
              </div>
              <div>
                <label for="phone_${i}" class="block text-sm font-medium text-gray-700 mb-1">Phone <span class="text-red-500">*</span></label>
                <input type="tel" id="phone_${i}" name="phone_${i}" required class="input-field" />
              </div>
              <div class="md:col-span-2">
                <label for="passport_${i}" class="block text-sm font-medium text-gray-700 mb-1">Passport Number <span class="text-red-500">*</span></label>
