  ...
  <div class="booking-page pt-16 min-h-screen bg-gray-50">
    <div class="max-w-4xl mx-auto px-4 py-8">
      <div class="flight-details bg-white rounded-lg shadow-md p-6 mb-6">
        <h2 class="text-2xl font-bold mb-4"><span aria-hidden="true">✈️</span> Flight Details</h2>
      ...
      <form action="PaymentPage.jsp" method="POST" id="booking-form">
        ...
        <c:forEach var="i" begin="0" end="${passengers - 1}">
          <div class="passenger-info bg-white rounded-lg shadow-md p-6 mb-6">
            <h3 class="text-xl font-semibold mb-4"><span aria-hidden="true">👤</span> Passenger ${i + 1}</h3>
        ...
        <button type="submit" class="btn-submit" id="submit-btn">Proceed to Payment</button>
      </form>
    </div>
  </div>
  <script>
